...
1. Home Screen ![IMG_6168](https://github.com/user-attachments/assets/b3ac04de-903e-42fa-ab04-183c2c27da29) 
2. Notification Screen ![IMG_6169](https://github.com/user-attachments/assets/1048a42d-5db6-4e14-8ca1-0dddc23128e6)
3. Alogkit Connected to Lora Screen ![IMG_6170](https://github.com/user-attachments/assets/11693648-ffd4-499e-b373-0f39f8cc9c7c)
4. History Screen ![IMG_6173](https://github.com/user-attachments/assets/b1eeef89-3e27-4ff2-8deb-56f022a57192)
5. More History Screen ![IMG_6174](https://github.com/user-attachments/assets/9669ed5e-dd36-48f7-b05b-1484997bfa35) 
6. Mora History Screen ![IMG_6175](https://github.com/user-attachments/assets/25aa75b2-bc3e-4050-b3e5-365df723cb01)
7. Account type Screen ![IMG_6176](https://github.com/user-attachments/assets/e14ff976-67fb-421e-b300-2dd5bcc2b1dd)
...
#### Setting up GitHub for CI/CD workflow and TestNet deployment
  ...
  2. Decide what values you want to use for the `allow_update`, `allow_delete` and the `on_schema_break`, `on_update` parameters specified in [`contract.py`](./smart_contracts/pay_rent_smart_contract/contract.py).
